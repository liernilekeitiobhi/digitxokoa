...
/*
 * Ditugun puntuak hartuta, kalkulatuko du ea puntu horiek dituen funtzio esponentziala existitzen den. 
...
function draw(){ 
    if (parameters.data[0].points < 3) {
        ...
        */
        ...
        if (!existentzia){
            alert('Puntu horiekin ezin dut funtzio esponentzial bat marraztu!')
            return false
        }        
        else{
